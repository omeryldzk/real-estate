...
class HepsiemlakSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for listing in listings:
            yield {
                'id': listing.css('article::attr(id)').get(),
                ...
                'location': listing.css('.list-view-location__icon::text').get().strip(),
                ...
                'image_url': listing.css('.img-link-picture img::attr(src)').get(),
                'agency_logo': listing.css('.branded img::attr(src)').get(),
                'contact_number': listing.css('button.action-telephone::attr(title)').get(),
                'message_button': listing.css('button span.message-alternative').get() is not None,
                'whatsapp_button': listing.css('button span.he-icon--whatsapp-transparent').get() is not None,
            }
